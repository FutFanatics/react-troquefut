      ...
      <div className="row">
        <Box className="flex-column d-flex align-items-center justify-content-center col-md-4" margin="0px">
          <a href={selectedProduct.url} target="_blank">
            <img className="product-selected-img" src={selectedProduct.img} alt={selectedProduct.name} />
          </a>
          <SH1 fontSize="15px" margin="12px 0px 8px 0px" fontWeight={500}>{selectedProduct.name}</SH1>
          <SspanText fontSize="16px">Variação: {selectedProduct.variant_value}</SspanText>
        </Box>
